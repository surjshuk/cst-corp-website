...
export const cloudPaloTabData:CloudSpecialType[] = [
{
    image:keyglobal,
...
export const fortiGateTabData:CloudSpecialType[] = [
{
    image:keyfortigate,
...
export const arubaTabData:CloudSpecialType[] = [
{
    image:hpearuba,
