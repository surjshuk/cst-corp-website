...
const WhatWeDo = () => {
  return (
   <Section id='what-we-do' data-id="what-we-do">
        <div className="border-t border-black pt-10 md:mx-12 mx-5 md:mt-20 mt-16">
            ...
            <div className="flex md:flex-row flex-col md:justify-end md:items-start items-end md:gap-16 gap-8 2xl:my-24 lg:my-16 my-12 2xl:me-32 lg:me-12">
              <p className="text-base 2xl:w-2/12 md:w-[32%]  w-[80%]">CST is ready to help you overcome the constraints that time and distance traditionally impose on transforming your business and, consequently, your profitability and competitiveness.</p>
