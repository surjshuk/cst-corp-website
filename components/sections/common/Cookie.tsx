    ...
    return (
        <div className="bg-black text-white p-5 tablet:px-12 tablet:py-10 laptop:ml-0 laptop:px-20 laptop:py-10">
            <div className="w-1/2 space-y-4">
                <p className="text-xs">
                    We use cookies on <Link href="" className="text-primary">.in</Link> to make your experience better—personalized content, smooth browsing, and added security. You can update your preferences anytime. Learn more in our <Link href="" className="text-primary">Privacy Policy</Link>.
                </p>
