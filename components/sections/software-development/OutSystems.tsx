...
export const OutSystems = () => {
    return (
        <>  
            ...
            />
            <Special tabData={outSystemsData} className={"h-[600vh]"} imageSrc={PLACEHOLDER} mask="black/50"/>
            ...
            />
            <Special tabData={outSystemsAnotherData} className={"h-[600vh]"} imageSrc={PLACEHOLDER} mask="black/50"/>
